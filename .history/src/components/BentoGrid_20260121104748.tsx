    ...
    [
        ...
        { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[#7029CF]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.jpg", characterImage: "/cards/character.png" },
            ...
            { id: 14, title: "Communications", description: "Centralized messaging and notification system for all stakeholders.", color: "bg-[#242424]", span: "col-span-1 row-span-2" },
              { id: 8, title: "Operations Center", description: "Central hub linking key operational tasks for seamless tracking, reporting, and workflow management.", color: "bg-[#242424]", span: "col-span-2 row-span-1", cardImage: "/cards/card8.svg", layoutType: "row" },
    ],
    // Page 3
    [
      { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[#7029CF]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.jpg", characterImage: "/cards/character.png" },
