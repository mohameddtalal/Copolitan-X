...
const BentoGrid = () => {
    ...
    const pages = [
        ...
        // Page 3
        [
            { id: 14, title: "Data Hub", description: "A streamlined repository for all data collect, analyze, and access key metrics to drive informed decisions.", color: "bg-[#FFD3D2]", span: "col-span-1 row-span-1" },
            { id: 2, title: "", description: "", color: "bg-[var(--background)]", span: "col-span-1 row-span-1", image: "/cards/CIRCULAR TEXT.svg" },
            { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[var(--background)]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.svg", characterImage: "/cards/character.svg" },
                        ...
                        <div key={pageIndex} className="min-w-full h-full px-1.5 sm:px-2 md:px-2 lg:px-3 xl:px-4 flex items-center justify-center">
                            ...
                            />
                                            ...
                                            // Card without image
                                                <>
                                                <div>
                                                    <h2 className={`mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 lora-semibold-italic ${getTitleSizeClass(card.id)} ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                                                    <p className={`opacity-90 line-clamp-3 font-gtwalsheim ${getDescSizeClass(card.id)} ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                </div>
