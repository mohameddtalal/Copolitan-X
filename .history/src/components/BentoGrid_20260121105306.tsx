                ...
                {page.map((card) => (
                  ...
                  >
                    {card.isSplit ? (
                      ...
                      <>
                        <div>
                          <h2 className={`text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-bold mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 italic ${card.id === 8 || card.id === 1 ||card? 'text-black' : 'text-white'}`}>{card.title}</h2>
