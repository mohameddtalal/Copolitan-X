                                        ...
                                        {card.isSplit ? (
                                            ...
                                            <>
                                                ...
                                                <div className="relative z-10 mt-auto">
                                                    ...
                                                    <p className={`opacity-90 line-clamp-2 font-gtwalsheim whitespace-pre-line${getDescSizeClass(card.id)}`}>{card.description}</p>
                                                </div>
                                            </>
                                        ) : card.cardImage ? (
                                            ...
                                            <>
                                                {card.layoutType === 'column' ? (
                                                    ...
                                                    <div className="flex flex-col gap-1 sm:gap-1 md:gap-2 lg:gap-3 xl:gap-4 flex-1">
                                                        ...
                                                        <p className={`opacity-90 line-clamp-3 font-gtwalsheim whitespace-pre-line${getDescSizeClass(card.id)} ${card.id === 8 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                    </div>
                                                ) : (
