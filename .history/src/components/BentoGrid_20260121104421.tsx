  ...
  const pages = [
    ...
    [
        ...
        { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[#7029CF]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.jpg", characterImage: "/cards/character.png" },
            { id: 12, title: "Finance Center", description: "A control panel for streamlined financial records and insights collaborations.", color: "bg-pink-500", span: "col-span-1 row-span-2", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop" },
