                        ...
                        <div key={pageIndex} className="min-w-full h-full px-1.5 sm:px-2 md:px-2 lg:px-3 xl:px-4 flex items-center justify-center">
                            ...
                            />
                                            ...
                                            // Card without image
                                                <>
                                                <div>
                                                    <h2 className={`mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 lora-semibold-italic ${getTitleSizeClass(card.id)} ${card.id === 8 || card.id === 1 || card.id === 9 || card.id === 1 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
