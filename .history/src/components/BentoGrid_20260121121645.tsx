...
const BentoGrid = () => {
    ...
    const pages = [
        ...
        [
            ...
            { id: 10, title: "", description: "", color: "bg-[var(--background)]", span: "col-span-1 row-span-1", image: "/cards/CIRCULAR TEXT.svg" },
                                        ...
                                        {card.isSplit ? (
                                            ...
                                            <div className="flex flex-col h-full gap-2 sm:gap-3 lg:gap-4 sm:gap-3 ">
                                                ...
                                                <div className="flex flex-row items-center gap-2 sm:gap-3 p-1.5 sm:p-2 md:p-2.5 lg:p-3 xl:p-4 bg-[#7029CF] rounded-xl sm:rounded-2xl lg:rounded-3xl">
                                                    ...
                                                    <div className="flex flex-col justify-center flex-1">
                                                        <h2 className="text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-semibold italic font-lora">{card.title}</h2>
                                                        <p className="text-[8px] sm:text-[9px] md:text-xs lg:text-xs xl:text-sm opacity-90 font-gtwalsheim leading-[16px]">{card.description}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <>
                                                ...
                                                <div className="relative z-10 mt-auto">
                                                    <h2 className="text-[11px] sm:text-sm md:text-base lg:text-lg xl:text-2xl  mb-1 md:mb-1.5 lg:mb-2 xl:mb-3  font-lora ">{card.title}</h2>
                                                    <p className="text-[8px] sm:text-xs md:text-xs lg:text-sm xl:text-sm opacity-90 line-clamp-2 font-gtwalsheim">{card.description}</p>
                                                </div>
                                            </>
                                        ) : card.cardImage ? (
                                            ...
                                            <>
                                                {card.layoutType === 'column' ? (
                                                    ...
                                                    <div className="flex flex-col gap-2 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5 flex-1">
                                                        <h2 className={`text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg  font-lora ${card.id === 8 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                                                        <div className="flex justify-center items-center flex-1">
                                                            <img
                                                                src={card.cardImage}
                                                                alt={card.title}
                                                                className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-25 lg:h-25 xl:w-30 xl:h-30 object-contain"
                                                            />
                                                        </div>
                                                        <p className={`text-[8px] sm:text-[9px] md:text-xs lg:text-xs xl:text-sm opacity-90 line-clamp-3 font-gtwalsheim leading-[16px] ${card.id === 8 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                    </div>
                                                ) : (
                                                    ...
                                                    <div className="flex flex-row gap-1 sm:gap-1.5 md:gap-2 lg:gap-2.5 xl:gap-3 items-start h-full">
                                                        <div className="flex flex-col flex-1 gap-0.5 sm:gap-0.5 md:gap-1 lg:gap-1.5 xl:gap-2">
                                                            <h2 className={`text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-semibold italic font-lora ${card.id === 8 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                                                            <p className={`text-[8px] sm:text-[9px] md:text-xs lg:text-xs xl:text-sm opacity-90 font-gtwalsheim leading-[16px] ${card.id === 8 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                        </div>
                                                        <img
                                                            src={card.cardImage}
                                                            alt={card.title}
                                            ...
                                            <>
                                                <div>
                                                    <h2 className={`text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-semibold mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 italic font-lora ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                                                    <p className={`text-[8px] sm:text-[9px] md:text-xs lg:text-xs xl:text-sm opacity-90 line-clamp-3 font-gtwalsheim leading-[16px] ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                </div>
