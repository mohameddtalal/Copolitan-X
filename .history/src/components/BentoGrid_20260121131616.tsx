                      ...
                      <>
                        {card.layoutType === 'column' ? (
                          ...
                          <div className="flex flex-col gap-2 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5 flex-1">
                            ...
                            <p className={`text-[clamp(12px,1.8vw,16px)] leading-[clamp(18px,2.5vw,24px)] opacity-90 line-clamp-3 font-gtwalsheim ${card.id === 8 || card.id? 'text-black' : 'text-white'}`}>{card.description}</p>
                          </div>
                        ) : (
