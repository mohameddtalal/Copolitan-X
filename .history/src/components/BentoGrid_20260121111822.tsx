...
const BentoGrid = () => {
  ...
  const pages = [
    ...
    [
      ...
      { id: 20, title: "Inventory System", description: "Track supplies, equipment, and asset management.", color: "bg-amber-500", span: "col-span-1 row-span-1" },
      { id: 21, title: "Customer Support", description: "Handle inquiries, tickets, and member support requests.", color: "bg-rose-600", span: "col-span-2 row-span-2" },
      { id: 22, title: "Marketing Tools", description: "Create campaigns and track engagement metrics.", color: "bg-fuchsia-500", span: "col-span-1 row-span-2" },
      { id: 23, title: "Integration Hub", description: "Connect with third-party tools and services seamlessly.", color: "bg-lime-500", span: "col-span-1 row-span-1" },
      { id: 24, title: "Security Center", description: "Monitor access controls and security protocols.", color: "bg-gray-800", span: "col-span-1 row-span-1" },
      { id: 25, title: "Billing Portal", description: "Manage invoices, payments, and subscription plans.", color: "bg-emerald-600", span: "col-span-2 row-span-1" },
  ...
  return (
    <div className="w-full h-full p-1 sm:p-2 md:p-3 lg:p-5 xl:p-7 flex flex-col overflow-hidden">
      {/* Navigation Section */}
      <div className="flex items-center justify-between mb-3 sm:mb-5 shrink-0">
        <div className="flex gap-2 sm:gap-3 justify-between w-full" style={{ marginRight: 'clamp(1rem, 0rem + 3.125vw, 1.5rem)', marginLeft: 'clamp(1rem, 0rem + 3.125vw, 1.5rem)' }}>    
          ...
          >
            <img 
              src={currentPage === 0 ? "/button icon 1.svg" : "/button icon 2.svg"}
              alt="Previous"
          ...
          >
            <img 
              src={currentPage === pages.length - 1 ? "/button icon 4.svg" : "/button icon 5.svg"}
              alt="Next"
              className="w-2 h-2 sm:w-3 sm:h-3 lg:w-5 lg:h-5"
            />
          </button>
