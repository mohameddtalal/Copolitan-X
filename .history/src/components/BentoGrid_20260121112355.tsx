                ...
                {page.map((card) => (
                  ...
                  >
                    {card.isSplit ? (
                      ...
                      <div className="flex flex-col h-full justify-between p-2 sm:p-2.5 md:p-3 lg:p-4 xl:p-6">
                        {/* Top section - Profile and info in row */}
                        <div className="flex flex-row items-center gap-2 sm:gap-3 p-1.5 sm:p-2 md:p-2.5 lg:p-3 xl:p-4 bg-[#7029CF] rounded-xl sm:rounded-2xl lg:rounded-3xl shrink-0">
                          {/* Profile Image */}
                          {card.profileImage && (
                            <img 
                        ...
                        <div className=" rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden flex items-center justify-center flex-1">
                          {card.characterImage && (
                            <img 
                      ...
                      <>
                        <div>
                          <h2 className={`text-[11px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-bold mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 italic ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                          <p className={`text-[8px] sm:text-[9px] md:text-xs lg:text-xs xl:text-sm opacity-90 leading-relaxed line-clamp-3 ${card.id === 8 || card.id === 1 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                        </div>
