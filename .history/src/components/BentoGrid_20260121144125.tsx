...
const BentoGrid = () => {
    ...
    const pages = [
        ...
        [
            ...
            { id: 8, title: "Operations <br>Center", description: "Central hub linking key operational tasks for seamless tracking, reporting, and workflow management.", color: "bg-[var(--green)]", span: "col-span-2 row-span-1", cardImage: "/cards/card8.svg", layoutType: "row" },
        ],
        // Page 2
        [
                                        ...
                                        {card.isSplit ? (
                                            ...
                                            <>
                                                <div>
                                                    ...
                                                    <p className={`opacity-90 line-clamp-3 font-gtwalsheim whitespace-pre-line ${getDescSizeClass(card.id)} ${card.id === 8 || card.id === 1 || card.id === 9 || card.id === 16 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                                                </div>
