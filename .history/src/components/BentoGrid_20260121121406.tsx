                                        ...
                                        {card.isSplit ? (
                                            ...
                                            <>
                                                ...
                                                <div className="relative z-10 mt-auto">
                                                    <h2 className="text-[11px] sm:text-sm md:text-base lg:text-lg xl:text-2xl  mb-1 md:mb-1.5 lg:mb-2 xl:mb-3  font-lora leading-[202px]">{card.title}</h2>
                                                    <p className="text-[8px] sm:text-xs md:text-xs lg:text-sm xl:text-sm opacity-90 line-clamp-2 font-gtwalsheim leading-[16px]">{card.description}</p>
                                                </div>
                                            </>
                                        ) : card.cardImage ? (
