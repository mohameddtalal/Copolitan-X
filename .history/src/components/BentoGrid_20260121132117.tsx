                        ...
                        <div key={pageIndex} className="min-w-full h-full px-1.5 sm:px-2 md:px-2 lg:px-3 xl:px-4 flex items-center justify-center">
                            ...
                            />
                                                ...
                                                <div className="relative z-10 mt-auto">
                                                    <h2 className="text-[24px] sm:text-sm md:text-base lg:text-lg xl:text-2xl  mb-1 md:mb-1.5 lg:mb-2 xl:mb-3  font-lora ">{card.title}</h2>
                                                    <p className="text-[12px] sm:text-xs md:text-xs lg:text-sm xl:text-sm opacity-90 line-clamp-2 font-gtwalsheim">{card.description}</p>
                                                </div>
                                            </>
                                        ) : card.cardImage ? (
