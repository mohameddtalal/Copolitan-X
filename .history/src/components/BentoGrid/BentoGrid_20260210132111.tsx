...
const BentoGrid = () => {
    ...
    const pages = [
        ...
        [
            ...
            { id: 2, title: "", description: "", color: "bg-[var(--background)]", span: "col-span-1 row-span-1", image: "/cards/CIRCULAR TEXT.svg" },
            // Spacer 1 (replaces ID 3 position: col 3, row 1-2)
            { id: 101, title: " ", description: " ", color: "invisible pointer-events-none", span: "col-span-1 row-span-2" },
            { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[var(--background)]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.svg", characterImage: "/cards/character.svg" },
            // Spacer 2 (replaces ID 5 position: col 1, row 2-3)
            { id: 102, title: " ", description: " ", color: "invisible pointer-events-none", span: "col-span-1 row-span-2" },
            // Spacer 3 (replaces ID 6 position: col 2, row 2)
            { id: 103, title: " ", description: " ", color: "invisible pointer-events-none", span: "col-span-1 row-span-1" },
            // Spacer 4 (replaces ID 7 position: col 2, row 3)
            { id: 104, title: " ", description: " ", color: "invisible pointer-events-none", span: "col-span-1 row-span-1" },
            // Spacer 5 (replaces ID 8 position: col 3-4, row 3)
            { id: 105, title: " ", description: " ", color: "invisible pointer-events-none", span: "col-span-2 row-span-1" },
        ],
    ];
    const nextPage = () => {
    ...
    return (
        <div className="w-full h-full min-h-[670px] px-1 sm:px-1 md:px-2 lg:px-3 xl:px-5 flex flex-col overflow-hidden">
            {/* Navigation Section */}
            <Navigation
