...
const BentoGrid = () => {
    ...
    const pages = [
        ...
        [
            ...
            { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "invisible pointer-events-none", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.svg", characterImage: "/cards/character.svg" },
