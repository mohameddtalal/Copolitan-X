  ...
  const pages = [
    ...
    [
        ...
        { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[#7029CF]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.jpg", characterImage: "/cards/character.png" },
            ...
            { id: 13, title: "Experience & Engagement Lab", description: "A tools lab that drives engagement and growth where experience is refined and elevated.", color: "bg-orange-500", span: "col-span-1 row-span-1" },
