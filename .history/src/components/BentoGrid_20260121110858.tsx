...
const BentoGrid = () => {
  ...
  const pages = [
    ...
    [
        ...
        { id: 4, title: "fatma Ashraf", description: "Co-founder", color: "bg-[var(--background)]", span: "col-span-1 row-span-2", isSplit: true, profileImage: "/cards/profile.jpg", characterImage: "/cards/character.ng" },
