                ...
                {page.map((card) => (
                  ...
                  >
                    {card.isSplit ? (
                      ...
                      <>
                        {card.layoutType === 'column' ? (
                          ...
                          <div className="flex flex-col gap-2 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5 flex-1">
                            <h2 className={`text-[clamp(14px,2.5vw,24px)] leading-[clamp(22px,3vw,30px)] lora-semibold-italic ${card.id === 8 || card.id === 9 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                            ...
                            <p className={`text-[clamp(12px,1.8vw,16px)] leading-[clamp(18px,2.5vw,24px)] opacity-90 line-clamp-3 font-gtwalsheim ${card.id === 8 || card.id===9? 'text-black' : 'text-white'}`}>{card.description}</p>
                          </div>
                        ) : (
                      ...
                      <>
                        <div>
                          <h2 className={`text-[clamp(14px,2.5vw,24px)] leading-[clamp(22px,3vw,30px)] mb-0.5 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 lora-semibold-italic ${card.id === 8 || card.id === 1 ? 'text-black' : 'text-white'}`}>{card.title}</h2>
                          <p className={`text-[clamp(12px,1.8vw,16px)] leading-[clamp(18px,2.5vw,24px)] opacity-90 line-clamp-3 font-gtwalsheim ${card.id === 8 || card.id === 1 ? 'text-black' : 'text-white'}`}>{card.description}</p>
                        </div>
