...
"use client";
import { BrandHeader, WhiteBrandHeader } from "@/app/Shared/Functions";
  ...
  return (
    ...
    {/* Welcome heading */}
        ...
        <div className={styles.formGroup}>
          <label className={styles.whitelabel}>
            E-Mail
          </label>
          <input
            ...
            className={emailError ? styles.whiteinputError : styles.whiteinput}
        ...
        <div className={styles.formGroupSmall}>
          ...
          <div className={passwordError ? styles.whitepasswordWrapperError : styles.whitepasswordWrapper}>
            <input
              type={showPassword ? "text" : "password"}
              value={password}
              onChange={(e) => setPassword(e.target.value)}
              className={passwordError ? styles.whitepasswordInputError : styles.whitepasswordInput}
        ...
        {/* Footer */}
        <div className={`${styles.whitefooter} font-gtwalsheim`}>
