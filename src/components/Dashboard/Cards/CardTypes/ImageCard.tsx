    ...
    <>
      <div className="absolute inset-0 bg-[#F7F7F7]">
        {card.id === 2 ? (
          <>
            <motion.img
              src={isWhiteTheme ? "/cards/frame-white.svg" : "/cards/frame.svg"}
              alt="frame"
            ...
            />
            <img
              src={isWhiteTheme ? "/cards/X-white.svg" : "/cards/X.svg"}
              alt="X"
      ...
      <div className="relative z-10 mt-auto">
        <h2 className={`mb-1 md:mb-1.5 lg:mb-2 xl:mb-3 whitespace-pre-line ${getTitleSizeClass(card.id)}`}>
          {card.title}
        </h2>
        <p className={`whitespace-pre-line ${getDescSizeClass(card.id)}`}>
          {card.description}
        </p>
      </div>
    </>
